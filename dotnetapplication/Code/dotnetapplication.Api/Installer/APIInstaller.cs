...
using ElmahCore.Mvc;
using ElmahCore;
using dotnetapplication.Api.Filters;
using dotnetapplication.Business.Installer;

namespace dotnetapplication.Api.Installer
{
    public class APIInstaller
    {
        ...
        public void Install()
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "dotnetapplication API", Version = version + "-" + branch});
            });
